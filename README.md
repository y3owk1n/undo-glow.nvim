...
```lua
{
  ...
  opts = {
    animation = {
      enabled = true,
      duration = 300,
      animation_type = "fade", -- or "zoom", "pulse", "slide", etc.
    },
    highlights = {
      undo = { hl_color = { bg = "#693232" } },   -- Dark red
      redo = { hl_color = { bg = "#2F4640" } },   -- Dark green
      yank = { hl_color = { bg = "#7A683A" } },   -- Dark yellow
      paste = { hl_color = { bg = "#325B5B" } },  -- Dark cyan
      search = { hl_color = { bg = "#5C475C" } }, -- Dark purple
    },
  },
  keys = {
    -- Basic operations
    { "u", function() require("undo-glow").undo() end, desc = "Undo with highlight" },
    { "U", function() require("undo-glow").redo() end, desc = "Redo with highlight" },
    { "p", function() require("undo-glow").paste_below() end, desc = "Paste below" },
    { "P", function() require("undo-glow").paste_above() end, desc = "Paste above" },

    -- Search operations
    { "n", function() require("undo-glow").search_next() end, desc = "Search next" },
    { "N", function() require("undo-glow").search_prev() end, desc = "Search previous" },
    { "*", function() require("undo-glow").search_star() end, desc = "Search word forward" },
    { "#", function() require("undo-glow").search_hash() end, desc = "Search word backward" },
  },
  init = function()
